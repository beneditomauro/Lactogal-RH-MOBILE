//
//  NotificationsDoneControler.swift
//  Lactogal RH
//
//  Created by Mauro Jorge Costa dos Santos Benedito on 21/03/2019.
...
class DoneTasksController: UICollectionViewController, UICollectionViewDelegateFlowLayout
{
    ...
    private func getDoneNotifications() {
        
        ApiService.shared.fetchNotificationsDone{(notificacoes: [notificacao]) in
    ...
    private func listenTDoneNotifications()
    {
...
//        setupMenuTopBar() // funcao que
    ...
    fileprivate func setupViewTitleLabel()
    {
        ...
        titleLabel.text = "Notificações com resposta"
    ...
    fileprivate func setupCollectionView()
    {
        ...
        collectionView?.register(NotificationsWaintingView.self, forCellWithReuseIdentifier: waintingCellId)
        collectionView?.register(NotificationDoneView.self, forCellWithReuseIdentifier: doneCellId)
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: waintingCellId, for: indexPath) as! NotificationsWaintingView
